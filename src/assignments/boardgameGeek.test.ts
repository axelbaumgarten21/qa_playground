import {
  ...
  class BggPage {
    ...
    headerLogo: By = By.xpath("//*[@class='menu-logo-symbol']"); // need a locator
    searchBar: By = By.xpath("//*[@name='searchTerm']"); // need a locator
    gamePageName: By = By.xpath("//h1/a"); // need a locator
    gamePageRating: By = By.xpath("//*[@ng-show='showRating']"); // need a locator
